...
##2. lé o arquivo rds e armazenar em um objeto 
...
#para múltipas comparações da mesma variável
dados_vendas_limpos |>
...
#seleciona apenas as oclunas cidade, produto e receita 
dados_vendas_limpos |>
  select(cidade, produto, receita) 

#remove as colunas representante e cidade 
dados_vendas_limpos |>
  selec(-representante, -cidade)
...
#Calcula p número total de vendas realizadas
dados_vendas_limpos |>  
